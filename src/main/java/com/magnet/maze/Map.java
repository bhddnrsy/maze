...
public class Map {
	...
	public Map(){
		...
		img = new ImageIcon(Maze.class.getResource("/images/base16.png"));
		base = img.getImage();
		img = new ImageIcon(Maze.class.getResource("/images/wall16.jpg"));
		wall = img.getImage();
		img = new ImageIcon(Maze.class.getResource("/images/finish16.png"));
		finish = img.getImage();
